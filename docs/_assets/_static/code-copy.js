...
var a = class extends HTMLElement {
  ...
  K(t4, i5) {
    ...
    if (n7 !== void 0 && this.\u03A0h !== n7) {
      const t5 = r5.getPropertyOptions(n7), l4 = t5.converter, a4 = (h4 = (e5 = (s5 = l4) === null || s5 === void 0 ? void 0 : s5.fromAttribute) !== null && e5 !== void 0 ? e5 : typeof l4 == "function" ? l4 : null) !== null && h4 !== void 0 ? h4 : o2.fromAttribute;
...
function S2(t4, i5, s5 = t4, e5) {
  ...
  if (i5 === w)
    return i5;
  let r5 = e5 !== void 0 ? (o6 = s5.\u03A3i) === null || o6 === void 0 ? void 0 : o6[e5] : s5.\u03A3o;
  const u3 = d(i5) ? void 0 : i5._$litDirective$;
  return (r5 == null ? void 0 : r5.constructor) !== u3 && ((l4 = r5 == null ? void 0 : r5.O) === null || l4 === void 0 || l4.call(r5, false), u3 === void 0 ? r5 = void 0 : (r5 = new u3(t4), r5.T(t4, s5, e5)), e5 !== void 0 ? ((n7 = (h4 = s5).\u03A3i) !== null && n7 !== void 0 ? n7 : h4.\u03A3i = [])[e5] = r5 : s5.\u03A3o = r5), r5 !== void 0 && (i5 = S2(t4, r5.S(t4, i5.values), r5, e5)), i5;
}
var k = class {
  constructor(t4, i5) {
  ...
  u(t4) {
    ...
    E.currentNode = o6;
    let l4 = E.nextNode(), n7 = 0, h4 = 0, r5 = e5[0];
    for (; r5 !== void 0; ) {
      if (n7 === r5.index) {
        let i6;
        r5.type === 2 ? i6 = new C(l4, l4.nextSibling, this, t4) : r5.type === 1 ? i6 = new r5.ctor(l4, r5.name, r5.strings, this, t4) : r5.type === 6 && (i6 = new z(l4, this, t4)), this.l.push(i6), r5 = e5[++h4];
      }
...
var h3 = class extends a {
  ...
  createRenderRoot() {
    ...
    return (t4 = (e5 = this.renderOptions).renderBefore) !== null && t4 !== void 0 || (e5.renderBefore = r5.firstChild), r5;
  }
  update(t4) {
...
function r4(r5) {
  return e4({ ...r5, state: true, attribute: false });
}
...
// private/rocket-plugin-code-tabs/components/copy.css
var copy_default = i`#copy-button {
  position: absolute;
  bottom: 0;
  right: 0;
...
// private/rocket-plugin-code-tabs/components/code-copy.ts
var supportsClipboard = "clipboard" in navigator;
var CodeCopy = class extends h3 {
  constructor() {
    super(...arguments);
...
CodeCopy.is = "code-copy";
CodeCopy.styles = [button_default, copy_default];
__decorateClass([
  r4()
], CodeCopy.prototype, "copyButtonText", 2);
CodeCopy = __decorateClass([
  n5("code-copy")
], CodeCopy);
export {
  CodeCopy
