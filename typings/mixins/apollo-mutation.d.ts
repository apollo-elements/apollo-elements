import ApolloClient, { MutationUpdaterFn, MutationOptions } from "apollo-client";
import { DocumentNode } from "graphql";
import ApolloElement from "./apollo-element";
import { FetchResult } from "apollo-link";
export default interface ApolloMutation<TCacheShape, TData, TVariables, TOptimisticResponse = {
    [key: string]: any;
