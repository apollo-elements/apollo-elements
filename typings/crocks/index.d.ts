declare type PredicateFunction = (x: any) => boolean;
declare module 'crocks/logic/and' {
    export default function and(p: PredicateFunction, q: PredicateFunction): PredicateFunction;
}
declare module 'crocks/logic/or' {
    export default function or(p: PredicateFunction, q: PredicateFunction): PredicateFunction;
}
declare module 'crocks/logic/not' {
    export default function not(p: PredicateFunction): PredicateFunction;
}
declare module 'crocks/predicates/hasProp' {
    export default function hasProp(x: string): PredicateFunction;
}
...
declare module 'crocks/predicates/isNil' {
    export default function isNil(x: any): Boolean;
}
...
declare module 'crocks/predicates/isPromise' {
    export default function isPromise(x: any): Boolean;
}
declare module 'crocks/predicates/isSame' {
    export default function isSame(x: any): Boolean;
}
declare module 'crocks/predicates/isString' {
    export default function isString(x: any): Boolean;
}
