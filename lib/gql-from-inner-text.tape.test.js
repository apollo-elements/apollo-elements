...
test('gqlFromInnerText Handles weird input', function(t) {
  t.throws(() => gqlFromInnerText(), errorRegexp, 'no params');
  t.throws(() => gqlFromInnerText({}), errorRegexp, 'undefined params');
  t.throws(() => gqlFromInnerText(null), errorRegexp, 'null params');
  t.throws(() => gqlFromInnerText(NaN), errorRegexp, 'NaN params');
