...
/** @typedef {import('zen-observable-ts')} ZenObservable */
 ...
 * @return {import('./return-constructor').ReturnConstructor<TBase, import('./apollo-query')<TCacheShape, TData, TVariables>>}
 *
 */
function ApolloQueryMixinFunction(superclass) {
  return class ApolloElement extends ApolloElementMixin(superclass) {
    /**
   ...
   */
     ...
     *
     * @return {import('apollo-client').NetworkStatus}
     */
      this.networkStatus;
...
export const ApolloQueryMixin = dedupeMixin(ApolloQueryMixinFunction);
