...
import ApolloClient, { ApolloError, MutationUpdaterFn, MutationOptions, NetworkStatus, ObservableQuery, ApolloQueryResult, FetchMoreOptions } from "apollo-client";
...
export default interface ApolloQuery<TCacheShape, TData, TVariables, TOptimisticResponse = { [key: string]: any }> extends ApolloElement<TCacheShape, TData> {
    query: DocumentNode;
