...
declare class ApolloQuery<TBase, TData, TVariables, TSubscriptionData = TData> extends ApolloElement<TBase, TData> implements ApolloQueryProperties<TData, TVariables> {
  variables: TVariables;
  tryFetch: Boolean;
  query: DocumentNode;
  pollInterval: Number;
